        ...
        <div class="row justify-content-center">
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" v-for="(item, index) in data.items" :key="index">
                            <a :href="item.torrent_magnet">
                                {{ item.file }} |
                                {{ item.quality }} |
                                {{ item.size_bytes | readableSize }} |
    ...
    methods: {
        fetchData() {
            ...
            if (localStorage.getItem(this.imdbid)) {
                ...
                axios
                    .get(
                        "https://cors-escape.herokuapp.com/http://api.ukfrnlge.com/show?imdb=" +
                            this.imdbid
                    )
                    .then(({ data }) => {
                        allData = data;
